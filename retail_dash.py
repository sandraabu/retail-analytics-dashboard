...
################################ total sales,profit, dicount Month level  ###################
...
############################## rounding sales,profit,discount to 1 decimal ##################
...
#sub_dept_df['Sub Category'] = sub_dept_df['Sub Category'].apply(lambda x: 'Dept'+" "+str(x))
...
body_app = dbc.Container([
    ...
    dbc.Row([
        dbc.Col([dbc.Card(id = 'card_num11',style={'height':'350px'})],width = 8),
        dbc.Col([dbc.Card(id = 'card_num12',style={'height':'350px'})]),
...
def update_cards(base, comparison):
    ...
    return card_content, card_content2,card_content3, card_content4, card_content5, card_content6, card_content7, card_content8,card_content9, card_content10, card_content11
